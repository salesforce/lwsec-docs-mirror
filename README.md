...
For example, if you are using `@locker/eslint-config-locker@0.19.17` in your project, view the repo at the [`v0.19.17` tag](https://github.com/salesforce/lwsec-docs-mirror/tree/v0.19.17).
